...
$RootPackageNameTests = "com.fullteaching.e2e.no_elastest.functional.test"
$SystemName           = "FullTeaching"
$JenkinsFilePath      = "./"
...
# Example of a command java -jar retorch-orchestration-1.2.1-60-creation-of-a-tool-cli-with-retorch-orchestration-20260527.130705-3-standalone.jar "com.fullteaching.e2e.no_elastest.functional.test" "FullTeaching" "./"