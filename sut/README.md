[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=augustocristian_full-teaching&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=augustocristian_full-teaching)
[![CI](https://github.com/augustocristian/full-teaching/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/augustocristian/full-teaching/actions/workflows/ci.yml)

# FullTeaching

**NOTE: This repo contains a detached fork of 
[FullTeaching](https://github.com/elastest/full-teaching) SUT
that is used as a System Test and as a demonstrator of the 
[RETORCH Framework](https://github.com/giis-uniovi/retorch). The project was migrated to a Java 21 and Springboot 3.4.3, solving all the problems that arised during this upgrade.
